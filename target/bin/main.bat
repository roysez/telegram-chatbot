...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="main" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.telegram.chatbot.Main %CMD_LINE_ARGS%
